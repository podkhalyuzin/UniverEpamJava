...
public class Patterns {
    ...
    public static final Pattern PROTOCOL =Pattern.compile("(http:\\/\\/|https:\\/\\/)");
    ...
    /**
     *
     *  Method check does this line is valid URL addres or not
     *
     * @param URL       line that should be checked on valid
     *
     * @return          true if URL is valid web address
     *                  false if not
     */
    public static boolean verifyAddres(String URL){
